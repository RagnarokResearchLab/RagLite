import { ArcRotateCamera, Color3, Engine, HemisphericLight, MeshBuilder, MultiMaterial, Scene, StandardMaterial, SubMesh, Vector3 } from "@babylonjs/core";
...
function CreateDemoScene() {
	...
	const camera = new ArcRotateCamera('camera', -Math.PI / 2, Math.PI / 4, 10, new Vector3(0, 2, 0), scene);
