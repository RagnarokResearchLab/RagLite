...
describe("UnlitMeshMaterial", function()
	...
	describe("Compile", function()
		it("should instantiate and assign the default rendering pipeline to all material instances", function()
			...
			assertEquals(materialInstanceA.surfaceRenderingPipeline, UnlitMeshMaterial.surfaceRenderingPipeline)
			assertEquals(materialInstanceB.surfaceRenderingPipeline, UnlitMeshMaterial.surfaceRenderingPipeline)
