...
describe("WaterSurfaceMaterial", function()
	...
	describe("Compile", function()
		it("should instantiate and assign the default rendering pipeline to all material instances", function()
			...
			assertEquals(materialInstanceA.surfaceRenderingPipeline, WaterSurfaceMaterial.surfaceRenderingPipeline)
			assertEquals(materialInstanceB.surfaceRenderingPipeline, WaterSurfaceMaterial.surfaceRenderingPipeline)

			assertTrue(instanceof(materialInstanceA.surfaceRenderingPipeline, WaterPlaneDrawingPipeline))
			assertTrue(instanceof(materialInstanceB.surfaceRenderingPipeline, WaterPlaneDrawingPipeline))
		end)
	end)
end)
