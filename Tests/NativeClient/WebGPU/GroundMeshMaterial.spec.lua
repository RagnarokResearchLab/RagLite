...
describe("GroundMeshMaterial", function()
	...
	describe("Compile", function()
		it("should instantiate and assign the default rendering pipeline to all material instances", function()
			...
			assertEquals(materialInstanceA.surfaceRenderingPipeline, GroundMeshMaterial.surfaceRenderingPipeline)
			assertEquals(materialInstanceB.surfaceRenderingPipeline, GroundMeshMaterial.surfaceRenderingPipeline)

			assertTrue(instanceof(materialInstanceA.surfaceRenderingPipeline, GroundMeshDrawingPipeline))
			assertTrue(instanceof(materialInstanceB.surfaceRenderingPipeline, GroundMeshDrawingPipeline))
		end)
	end)
end)
