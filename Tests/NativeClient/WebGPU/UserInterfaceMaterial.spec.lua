...
describe("UserInterfaceMaterial", function()
	...
	describe("Compile", function()
		it("should instantiate and assign the UI rendering pipeline to all material instances", function()
			...
			assertEquals(materialInstanceA.surfaceRenderingPipeline, UserInterfaceMaterial.surfaceRenderingPipeline)
			assertEquals(materialInstanceB.surfaceRenderingPipeline, UserInterfaceMaterial.surfaceRenderingPipeline)

			assertTrue(instanceof(materialInstanceA.surfaceRenderingPipeline, WidgetDrawingPipeline))
			assertTrue(instanceof(materialInstanceB.surfaceRenderingPipeline, WidgetDrawingPipeline))
		end)
	end)
end)
