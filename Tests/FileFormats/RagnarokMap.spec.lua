...
describe("RagnarokMap", function()
	describe("Construct", function()
		...
		it("should return the complete scene definition if a valid map ID was passed", function()
			...
			assertEquals(map.meshes[3].diffuseTextureImage.rgbaImageBytes, blankImage)
			assertEquals(map.meshes[3].diffuseTextureImage.width, 256)
			assertEquals(map.meshes[3].diffuseTextureImage.height, 256)
